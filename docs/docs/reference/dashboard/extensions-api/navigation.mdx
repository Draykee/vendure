...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/nav-menu/nav-menu-ids.ts" sourceLine="92" packageName="@vendure/dashboard" since="3.8.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/nav-menu/nav-menu-ids.ts" sourceLine="102" packageName="@vendure/dashboard" since="3.8.0" />
